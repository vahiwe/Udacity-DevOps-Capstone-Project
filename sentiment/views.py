...
from sentiment.config import consumer_key, consumer_secret, access_token, access_token_secret
...
def feedback(request):
    ...
    if request.method == 'POST':
        ...
        message = str(message)
        userfeedback = open("static/feedback.txt", "a+")
        userfeedback.write(message+"\n\n")
        userfeedback.close()
        return redirect('/')
